...
const LEVEL_NAMES = [
  'Principiante', 'Emprendedor', 'Comerciante', 'Empresario',
  'Magnate', 'Tycoon', 'Leyenda', 'Barrio Boss',
];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Logo */}
        <span style={{
          fontFamily: 'Fredoka One, cursive', color: '#FFE135',
          fontSize: '13px', letterSpacing: '0.5px', whiteSpace: 'nowrap',
        }}>
          🏘️ Imperio
        </span>
        ...
        {user ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{
              fontSize: '11px', color: 'rgba(255,255,255,0.6)', fontWeight: 900,
              fontFamily: 'Nunito, sans-serif', whiteSpace: 'nowrap',
              overflow: 'hidden', maxWidth: '120px', textOverflow: 'ellipsis',
            }}>
              {user.email?.split('@')[0]}
            </span>
            ...
            <button
              ...
              style={{
                ...
                color: 'rgba(255,71,87,0.8)', fontSize: '10px', whiteSpace: 'nowrap',
              }}
            >Salir</button>
          </div>
        ) : (
          <button
            ...
            style={{
              background: 'rgba(255,225,53,0.12)', border: '1px solid rgba(255,225,53,0.4)',
              borderRadius: '6px', padding: '4px 10px', cursor: 'pointer',
              color: '#FFE135', fontFamily: 'Fredoka One, cursive',
          ...
          <div style={modal}>
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              ...
              <p style={{ color: '#aaa', fontSize: '13px' }}>
                {authMode === 'login'
                  ? 'Carga tu progreso desde la nube'
                  : 'Guarda tu progreso y compite en el ranking'}
              </p>
            </div>
            ...
            <form onSubmit={handleAuth}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px', justifyContent: 'center' }}>
                    {AVATARS.map(av => (
                      <button
                        ...
                        style={{
                          fontSize: '1.4rem', padding: '6px 8px', borderRadius: '10px',
                          border: '2px solid',
              ...
              {formError && (
                <div style={{
                  background: 'rgba(255,71,87,.15)', border: '1px solid #FF4757',
        ...
        <div style={overlay} onClick={e => e.target === e.currentTarget && setShowLeaderboard(false)}>
          <div style={{ ...modal, maxWidth: '560px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
              <div>
                <h2 style={{ fontFamily: 'Fredoka One', color: '#FFE135', fontSize: '1.5rem', margin: 0 }}>
                  🏆 Ranking del Barrio
                </h2>
                {myRank && (
            ...
            {myRank && myRank > 3 && (
              <div style={{
                background: 'rgba(255,225,53,.1)', border: '2px solid #FFE135',
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: '40px 32px 1fr 90px 60px 50px',
              gap: '8px', padding: '6px 12px',
              color: '#888', fontSize: '11px', fontWeight: 900,
              textTransform: 'uppercase', letterSpacing: '.5px',
            }}>
              <span>#</span><span></span><span>Jugador</span>
              <span style={{ textAlign: 'right' }}>Ganado</span>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isMe
                            ? 'rgba(255,225,53,.12)'
                            : i < 3 ? 'rgba(255,255,255,.04)' : 'transparent',
